...
import MemberView from './MemberView.view'

const initialState = {
  modalTitle: 'Member Info',
  itemData: {},
  loading: false,
  fields: {},
  message: {
...
const MemberViewController: FC<any> = (props) => {
  const {
    BaseCrudViewService,
    modalTitle,
    itemData,
    ...
    isShowView,
    handleCallbackFunc,
  } = useCrudViewService(MemberApi, initialState, props)
...
export default React.memo(MemberViewController)
